...
partida do fluxo automatico, buscape traz as lojas, e a calculadora
consulta livelo e meliuz so para essas lojas especificas, ver
pages/1_Calculadora.py.

uma observacao importante, e a mesma transparencia que ja vale para
o scraper da livelo. o robots.txt do buscape atualmente nao permite
acesso automatizado, e o site tambem usa protecao contra navegador
...
agent realista e a ocultacao do sinal mais comum de automacao, os
mesmos recursos ja usados no scraper da livelo.

quando a consulta falhar, o caminho mais confiavel continua sendo
cadastrar a oferta manualmente na calculadora, that already existed
antes deste scraper e continua funcionando exatamente igual.
...
def buscar_ofertas_buscape(nome_produto, max_resultados=10, timeout_ms=45000, headless=True,
    ...
    for cartao in cartoes[:max_resultados]:
        ...
        ofertas.append(OfertaBuscape(loja=loja, preco=preco, url_produto=url_produto or ""))
