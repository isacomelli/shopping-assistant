...
def buscar_ofertas_combinadas(nome_produto, incluir_buscape_complementar=True,
    ...
    """
    , busca ofertas no google shopping como fonte principal e, quando incluir_buscape_complementar for True, tambem no buscape como fonte complementar, une as duas listas, marca a origem de cada oferta, e aplica normalizar_e_filtrar_ofertas para padronizar nomes de loja, remover resultados secundarios e deduplicar o conjunto final.
    ...
    """
    ofertas_google, erro_google = _buscar_no_google_shopping(nome_produto, buscar_ofertas_google_shopping)
    ...
    if incluir_buscape_complementar:
        ofertas_buscape, erro_buscape = _buscar_no_buscape_complementar(nome_produto, buscar_ofertas_buscape)
...
def pesquisar_produto_automaticamente(nome_produto, rendimento_mensal,
    ...
    """
    ofertas_encontradas, _erros_por_fonte = buscar_ofertas_combinadas(
        nome_produto,
